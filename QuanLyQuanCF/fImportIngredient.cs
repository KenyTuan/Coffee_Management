...
{
    public partial class fImportIngredient : Form
    {
        EFDbContext db = new EFDbContext();
        Ingredient ingredient;
        List<int> lsIngredientID = new List<int>();

        public fImportIngredient()
        {
            InitializeComponent();
        }

        private void fImportIngredient_Load(object sender, EventArgs e)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            fImportIngredient_Load(sender, e);
        }
